...
export const CONTRACT_ADDRESS =
  "CB7W4JB5KTVT5PM4VWC4JVXUR5CFOTYCW4QMON62GLZ24BSUXK2PS5YE";
...
// ============================================================
// DecentralizedBlog — Contract Methods
// ============================================================
...
/**
 * Create a new post (permissionless — anyone can post!)
 ...
 * Calls: get_posts() -> Vec<Post>
 */
export async function getPosts(): Promise<Post[]> {
  const result = await readContract("get_posts", []);
...
/**
 * Get total post count (read-only)
 * Calls: get_post_count() -> u64
 */
export async function getPostCount(): Promise<number> {
  const result = await readContract("get_post_count", []);
  if (result !== null) {
